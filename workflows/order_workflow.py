...
class OrderWorkflow:
    ...
    def full_flow(
        ...
        Args:
            ...
            stop_at: 执行到哪个阶段后停止，可选值：
                ...
                - 'pay_demand_audit', 'pay_writeoff' 新建 + ... + 发起付款需求 + 审核生成付款单
        ...
        Returns:
            {
                ...
                'pay_demand_audit_result': ...,  # stop_at='pay_demand_audit', 'pay_writeoff' 时存在
                'pay_writeoff_result': ...,  # stop_at='pay_writeoff' 时存在
            }
        """
        if bl_no is None:
        ...
        # Step 10: 订单锁定审批
        if stop_at in ('order_lock', 'invoice_apply', 'supplier_advance', 'fee_notice', 'fee_confirm', 'receive_account', 'confirm_account', 'invoice_batch', 'invoice_batch_audit', 'invoice_upload', 'receive_writeoff', 'payable', 'confirm_payable', 'payable_invoice_apply', 'payable_invoice_register', 'pay_demand', 'pay_demand_audit', 'pay_writeoff'):
        ...
        # Step 11: 未放款开票申请审批
        if stop_at in ('invoice_apply', 'supplier_advance', 'fee_notice', 'fee_confirm', 'receive_account', 'confirm_account', 'invoice_batch', 'invoice_batch_audit', 'invoice_upload', 'receive_writeoff', 'payable', 'confirm_payable', 'payable_invoice_apply', 'payable_invoice_register', 'pay_demand', 'pay_demand_audit', 'pay_writeoff'):
        ...
        # Step 12: 供应商垫付申请审批
        if stop_at in ('supplier_advance', 'fee_notice', 'fee_confirm', 'receive_account', 'confirm_account', 'invoice_batch', 'invoice_batch_audit', 'invoice_upload', 'receive_writeoff', 'payable', 'confirm_payable', 'payable_invoice_apply', 'payable_invoice_register', 'pay_demand', 'pay_demand_audit', 'pay_writeoff'):
        ...
        # Step 13: 生成费用通知单
        if stop_at in ('fee_notice', 'fee_confirm', 'receive_account', 'confirm_account', 'invoice_batch', 'invoice_batch_audit', 'invoice_upload', 'receive_writeoff', 'payable', 'confirm_payable', 'payable_invoice_apply', 'payable_invoice_register', 'pay_demand', 'pay_demand_audit', 'pay_writeoff'):
        ...
        # Step 14: 生成费用确认单
        if stop_at in ('fee_confirm', 'receive_account', 'confirm_account', 'invoice_batch', 'invoice_batch_audit', 'invoice_upload', 'receive_writeoff', 'payable', 'confirm_payable', 'payable_invoice_apply', 'payable_invoice_register', 'pay_demand', 'pay_demand_audit', 'pay_writeoff'):
        ...
        # Step 15: 发起应收对账批次
        if stop_at in ('receive_account', 'confirm_account', 'invoice_batch', 'invoice_batch_audit', 'invoice_upload', 'receive_writeoff', 'payable', 'confirm_payable', 'payable_invoice_apply', 'payable_invoice_register', 'pay_demand', 'pay_demand_audit', 'pay_writeoff'):
        ...
        # Step 16: 确认应收对账
        if stop_at in ('confirm_account', 'invoice_batch', 'invoice_batch_audit', 'invoice_upload', 'receive_writeoff', 'payable', 'confirm_payable', 'payable_invoice_apply', 'payable_invoice_register', 'pay_demand', 'pay_demand_audit', 'pay_writeoff'):
        ...
        # Step 17: 发起应收开票批次审批
        if stop_at in ('invoice_batch', 'invoice_batch_audit', 'invoice_upload', 'receive_writeoff', 'payable', 'confirm_payable', 'payable_invoice_apply', 'payable_invoice_register', 'pay_demand', 'pay_demand_audit', 'pay_writeoff'):
        ...
        if stop_at in ('invoice_batch_audit', 'invoice_upload', 'receive_writeoff', 'payable', 'confirm_payable', 'payable_invoice_apply', 'payable_invoice_register', 'pay_demand', 'pay_demand_audit', 'pay_writeoff'):
        ...
        # Step 19: 发票上传与登记
        if stop_at in ('invoice_upload', 'receive_writeoff', 'payable', 'confirm_payable', 'payable_invoice_apply', 'payable_invoice_register', 'pay_demand', 'pay_demand_audit', 'pay_writeoff'):
        ...
        if stop_at in ('receive_writeoff', 'payable', 'confirm_payable', 'payable_invoice_apply', 'payable_invoice_register', 'pay_demand', 'pay_demand_audit', 'pay_writeoff'):
        ...
        # Step 27: 付款单核销（formPage + writeoffPayFormList + orderFeePage + writeoffBatch）
        if stop_at == 'pay_writeoff':
            with allure.step('[pay_writeoff] Step27: 付款单核销'):
    ...
    @classmethod
    def run_until_pay_writeoff(
        cls,
        bl_no: str = None,
        fee_configs: List[Dict[str, Any]] = None,
    ) -> Dict[str, Any]:
        """执行到付款单核销阶段（link25 终点）"""
        return cls.full_flow(bl_no=bl_no, stop_at='pay_writeoff', fee_configs=fee_configs)
